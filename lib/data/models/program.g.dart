...
int _programEstimateSize(
  ...
  bytesCount += 3 + object.sessionsPerWeek.length * 8;
  return bytesCount;
}
...
void _programSerialize(
  ...
  writer.writeLongList(offsets[5], object.sessionsPerWeek);
}
...
Program _programDeserialize(
  ...
  object.objective = reader.readString(offsets[4]);
  object.sessionsPerWeek = reader.readLongList(offsets[5]) ?? [];
  return object;
}
...
extension ProgramQueryFilter
  ...
  QueryBuilder<Program, Program, QAfterFilterCondition>
      sessionsPerWeekElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Program, Program, QAfterFilterCondition>
      sessionsPerWeekElementGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Program, Program, QAfterFilterCondition>
      sessionsPerWeekElementLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Program, Program, QAfterFilterCondition>
      sessionsPerWeekLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'sessionsPerWeek',
        length,
  ...
  QueryBuilder<Program, Program, QAfterFilterCondition>
      sessionsPerWeekLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProgramQueryWhereDistinct
  ...
  QueryBuilder<Program, Program, QDistinct> distinctBySessionsPerWeek() {
    return QueryBuilder.apply(this, (query) {
...
extension ProgramQueryProperty
  ...
  QueryBuilder<Program, List<int>, QQueryOperations> sessionsPerWeekProperty() {
    return QueryBuilder.apply(this, (query) {
