...
void _exerciseSerialize(
  ...
  writer.writeBool(offsets[4], object.hasDurationRange);
  writer.writeBool(offsets[5], object.hasRepsRange);
  writer.writeBool(offsets[6], object.isDurationBased);
  writer.writeBool(offsets[7], object.isIsometric);
  writer.writeStringList(offsets[8], object.muscleIds);
  writer.writeString(offsets[9], object.name);
  writer.writeString(offsets[10], object.notes);
  writer.writeLong(offsets[11], object.reps);
  writer.writeLong(offsets[12], object.repsMax);
  writer.writeLong(offsets[13], object.repsMin);
  writer.writeLong(offsets[14], object.repsPerSide);
  writer.writeLong(offsets[15], object.restAfterExerciseSec);
  writer.writeLong(offsets[16], object.restBetweenSetsSec);
...
Exercise _exerciseDeserialize(
  ...
  object.id = id;
  object.isIsometric = reader.readBool(offsets[7]);
  object.muscleIds = reader.readStringList(offsets[8]) ?? [];
  object.name = reader.readString(offsets[9]);
  object.notes = reader.readStringOrNull(offsets[10]);
  object.reps = reader.readLongOrNull(offsets[11]);
  object.repsMax = reader.readLongOrNull(offsets[12]);
  object.repsMin = reader.readLongOrNull(offsets[13]);
  object.repsPerSide = reader.readLongOrNull(offsets[14]);
  object.restAfterExerciseSec = reader.readLong(offsets[15]);
  object.restBetweenSetsSec = reader.readLong(offsets[16]);
